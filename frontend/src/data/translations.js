...
export const translations = {
  ta: {
    ...
    hero: {
      ...
      serviceTime: 'ஞாயிறு — காலை 9:00 – 11:30 மணி',
    },
    about: {
    ...
    serviceTimes: {
      ...
      sunday: { day: 'ஞாயிறு ஆராதனை', time: 'காலை 9:00 – 11:30 மணி' },
    ...
    visit: {
      ...
      sundayLabel: 'ஞாயிறு',
      sundayTime: 'காலை 9:00 – 11:30 மணி',
      ctaDirections: 'வரும் வழி',
    ...
    footer: {
      ...
      city: 'திண்டுக்கல்',
      sunday9: 'ஞாயிறு — காலை 9:00 – 11:30 மணி',
      sunday11: 'வேதப் பயிற்சி — புதன் மாலை 7:00 மணி',
    ...
    notFound: {
      ...
      text: 'நீங்கள் தேடிய பக்கம் கிடைக்கவில்லை. மீண்டும் முயற்சிக்கவும்.',
  ...
  en: {
    ...
    hero: {
      ...
      serviceTime: 'Sunday — 9:00 AM – 11:30 AM',
    },
    about: {
    ...
    serviceTimes: {
      ...
      sunday: { day: 'Sunday Service', time: '9:00 AM – 11:30 AM' },
    ...
    notFound: {
      ...
      text: 'The page you are looking for could not be found. Please try again.',
      home: 'Back to Home',
    },
    videos: {
