...
export const translations = {
  ta: {
    ...
    hero: {
      ...
      serviceTime: 'ஞாயிறு — காலை 9:00 & 11:00',
    },
    about: {
    ...
    serviceTimes: {
      ...
      sundayMorning: { day: 'ஞாயிறு ஆராதனை', note: 'காலை' },
      sundayLate: { day: 'ஞாயிறு ஆராதனை', note: 'காலை' },
      wednesday: { day: 'வேத பயிற்சி', note: 'புதன் மாலை' },
    ...
    visit: {
      eyebrow: 'வருகை',
      heading: 'எங்களை வந்து சந்தியுங்கள்',
    ...
    footer: {
      ...
      sunday9: 'ஞாயிறு — காலை 9:00',
      sunday11: 'ஞாயிறு — காலை 11:00',
      wednesday: 'வேத பயிற்சி — புதன் மாலை 7:00',
  ...
  en: {
    ...
    hero: {
      ...
      location: 'Dindukkal, Tamil Nadu, India',
    ...
    about: {
      ...
      imageAlt: 'The congregation of Church of Christ, Dindukkal, worshipping together',
    },
    serviceTimes: {
    ...
    visit: {
      ...
      imageAlt: 'The Church of Christ building in Dindukkal',
    },
    footer: {
      description: 'A loving church in Dindukkal. The Word is Light.',
